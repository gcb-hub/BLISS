...
> 📊 **Drug-target validation benchmark:** reproduce our comparison of BLISS against MR, colocalization, and TWAS — code, data, and instructions in **[BENCHMARK.md](BENCHMARK.md)**.
