...
> 📊 **Drug-target validation benchmark:** reproduce our comparison of BLISS against MR, colocalization, TWAS, and closest-gene — code, data, and instructions in **[BENCHMARK.md](BENCHMARK.md)**.
