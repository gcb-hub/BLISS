...
Note: Although `APSS.r` offers option to keep only HapMap3 SNPs, we **DO NOT** recommend you using that option. As BLISS models were constructed using not just HapMap3, not restricting anaylsis to only HapMap3 SNPs is generally the better option.
